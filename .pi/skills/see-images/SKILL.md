---
name: see-images
description: Inspect image files by delegating to Grok 4.6. ONLY use when you (the current model) have NO vision capabilities yourself — if you can already see image attachments, never use this skill.
---
