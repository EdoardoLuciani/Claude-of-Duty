...
3. Play normally.
4. Press **F7** whenever something feels wrong or noteworthy. Type an optional note and **Enter** to save it. **Esc** is ignored while the note is open so it cannot steal the mouse.
