...
try {
  ...
  for (const [name, eye, target] of [
    ...
    ['W3-exterior', [-8, 5.5, -7.5], [-10, 1.7, -11.4]],
    ['W3-door', [-11.8, 5.1, -10.2], [-11.5, 3.5, -12.5]],
    ['W3-entrance', [-3.5, 2.0, -24.4], [-7.5, 1.1, -24.25]],
    ['W4-entrance', [-14.5, 2.4, -43.5], [-14.5, 1.3, -39.25]],
    ['W4-landing', [-18.5, 5.0, -35.0], [-21.15, 3.6, -33.25]],
    ['E4-stairs', [16.5, 3.2, -44.8], [19.09, 1.8, -41.5]],
    ['E4-opening', [17.4, 5.0, -39.6], [19.09, 2.5, -42.4]],
    ['E1-roof', [15.8, 11.2, 16], [17.15, 9.55, 14.6]],
    ['W1-exterior', [-9, 3.8, 6.7], [-7, .7, 9.3]],
    ['E2-roof', [6.1, 11.2, 4], [7.5, 9.55, 1.7]],
    ['E3-door', [24, 5, -17.5], [21.5, 3.45, -18.8]],
  ]) {
