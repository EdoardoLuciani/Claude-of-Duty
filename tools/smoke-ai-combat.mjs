...
function stubAgent(over = {}) {
  ...
  Object.assign(a, {
    ...
    lastKnownKind: 'visual', lastKnownRadius: 0,
    searchPoint: new THREE.Vector3(), _searchOrigin: new THREE.Vector3(),
    _searchCand: [new THREE.Vector3(), new THREE.Vector3(), new THREE.Vector3()],
    _searchCount: 0, _searchIndex: 0, _searchDwell: 0, _searchUntil: 0, _searchActive: false,
    position: new THREE.Vector3(),
