// Remaining previous-unsupported IDs that are still in the world under a
// different status (gap / overhang / unclassified), not true mid-air floats.
export const PREVIOUS_UNSUPPORTED_IDS = [
  'jerry_can/0015', 'tyre_small/0030', 'planter/0024',
];
