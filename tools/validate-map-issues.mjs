 ...
 *   node tools/validate-map-issues.mjs --only=w2,e1,float-sandbag
 *
...
const SHOTS = [
  { name: 'tyre-0005',   cam: [8.4, 1.3, 4.6],    target: [6.11, 0.55, 3.02],   doc: 'tyre_small/0005 @(6.11,0.65,3.02) bottom=0.64 support=0.07' },
  { name: 'tyre-0008',   cam: [-3.3, 1.3, 7.9],   target: [-5.60, 0.55, 6.22],  doc: 'tyre_small/0008 @(-5.60,0.65,6.22) bottom=0.62 support=0.07' },
  { name: 'tyre-0001',   cam: [-2.9, 1.2, 13.9],  target: [-5.17, 0.25, 12.45], doc: 'tyre_small/0001 @(-5.17,0.31,12.45) bottom=0.30 support=0.14' },
  { name: 'can-0036',    cam: [-3.6, 1.1, 26.3],  target: [-6.00, 0.28, 25.13], doc: 'can/0036 @(-6.00,0.34,25.13) bottom=0.32 support=0.07' },
  { name: 'rock-east-a', cam: [27.0, 1.2, -19.6], target: [29.27, 0.10, -21.38],doc: 'rock_b/1421 @(29.27,0.07,-21.38) bottom=0.04 support=-0.29' },
  { name: 'rock-east-b', cam: [17.0, 1.2, -12.2], target: [19.12, 0.10, -13.73],doc: 'rock_b/1359 @(19.12,0.07,-13.73) bottom=0.04 support=-0.28' },
  { name: 'rock-sw',     cam: [-28.2, 1.2, -44.4],target: [-30.43, 0.10, -46.16],doc: 'rock_b/1550 @(-30.43,0.07,-46.16) bottom=0.04 support=-0.19' },
  { name: 'rock-street', cam: [8.6, 1.2, -20.2],  target: [6.59, 0.05, -21.70], doc: 'rock_a/0634 @(6.59,0.07,-21.70) bottom=0.01 support=-0.16' },
